...
<body>
	<div class="container-fluid">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
							<h3>Cập Nhật Theo Dõi Vắng</h3>
					<c:url value="/edit-theodoi" var="url"/>
					<form:form action="${url}" modelAttribute="theodoi">
						<table class="table table-bordered text-center">
							<tr>
								<td style="width: 200px;">Mã Trẻ</td>
								<td>
									<form:input path="maTre" readonly="true" cssClass="form-control form-control-sm"/>
								</td>
							</tr>
							<tr>
								<td style="width: 200px;">Ngày Học</td>
								<td>
									<form:input path="ngayHoc" readonly="true" cssClass="form-control form-control-sm"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2">
									...
									<input value="Cập nhật" name="CapNhat" onclick="return xacNhanAn()" type="submit" style="float: right;" class="col-2 form-control btn btn-primary">
								</td>
							</tr>
 						</table>
					</form:form>
